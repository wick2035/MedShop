        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
          <div className="w-full max-w-md rounded-lg bg-white p-6 shadow-xl">
            <div className="mb-4 flex items-center justify-between">
              <h3 className="font-display text-lg font-semibold text-sage-800">Add Department</h3>
            ...
            <div className="mt-6 flex justify-end gap-3">
              ...
              <Button loading={formSubmitting} onClick={handleAdd}>Create</Button>
            </div>
          </div>
        </div>
      )}
      ...
      {editDept && (
        <div className="fixed inset-0 z-50 flex justify-end bg-black/40">
          <div className="h-full w-full max-w-md overflow-y-auto bg-white p-6 shadow-xl">
            <div className="mb-4 flex items-center justify-between">
              <h3 className="font-display text-lg font-semibold text-sage-800">Edit Department</h3>
            ...
            <div className="mt-6 flex justify-end gap-3">
              ...
              <Button loading={formSubmitting} onClick={handleEdit}>Save</Button>
            </div>
          </div>
        </div>
      )}
      ...
      {deleteDept && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
          <div className="w-full max-w-sm rounded-lg bg-white p-6 shadow-xl">
            <h3 className="mb-2 font-display text-lg font-semibold text-sage-800">Delete Department</h3>
            ...
            <div className="flex justify-end gap-3">
              ...
              <Button variant="danger" loading={formSubmitting} onClick={handleDelete}>Delete</Button>
            </div>
          </div>
        </div>
      )}
